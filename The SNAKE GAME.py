...
gameDisplay = pygame.display.set_mode(
    (display_width, display_height), HWSURFACE | DOUBLEBUF)
pygame.display.set_caption('THE SNAKE GAME (version - 1.2.0)')
...
def urlfb():
    new = 2
    url = "www.facebook.com/profile.php?id=100033415607333"
    webbrowser.open(url, new=new)


def urlin():
    new = 2
    url = "www.instagram.com/subham.kumar032/"
    webbrowser.open(url, new=new)


def urlgh():
    new = 2
    url = "https://github.com/TheShubham-K"
    webbrowser.open(url, new=new)
...
def scores(count):
    ...
    hmm = name.render("By : Shubham Kumar", True, white)
...
def crash():
    ...
    while True:
        ...
        button("Try Again", 120, 400, 120, 50,
               green, bright_green, 9, game_play)
        button("Main Menu", 350, 400, 150, 50,
               (112, 128, 144), (192, 192, 192), 9, intromusic)
...
def game_intro():
    ...
    while True:
        ...
        button("g", 703, 14, 35, 35, (29, 161, 242), (255, 255, 255), 7, urlgh)
        ...
        button("Settings", 608, 257, 149, 50,
               (112, 128, 144), (192, 192, 192), 9, sett)
...
def sett():
    ...
    while True:
        ...
        button("<- RETURN", 302, 540, 150, 50,
               (153, 217, 234), (163, 227, 244), 9, game_intro)

        button("Green", 100, 120, 100, 50, green, bright_green, 6, bcgcolgn)
        button("Violet", 275, 120, 100, 50,
               (167, 0, 237), (189, 33, 255), 6, bcgcolvl)
        button("Pink", 450, 120, 100, 50, (255, 116, 140),
               (255, 141, 161), 6, bcgcolpn)

        button("Yellow", 100, 240, 100, 50, yellow,
               (255, 255, 100), 6, blkcolyl)
        button("Black", 275, 240, 100, 50, (169, 169, 169),
               (207, 207, 207), 6, blkcolbl)
...
def info():
    ...
    while True:
        ...
        TextSurf7, TextRect7 = text_objects(
            "Developer : SHUBHAM KUMAR  :: Contact Links-", cred1)
        TextSurf8, TextRect8 = text_objects(
            "Special thanks to Ketchapp Inc. and Gamotronix Inc. for the music.", cred2)
        ...
        button("<- RETURN", 303, 500, 150, 50,
               cyan, (100, 255, 255), 6, game_intro)
        button("f", 545, 185, 35, 35, (59, 89, 239), (68, 143, 255), 7, urlfb)
        button("[o]", 603, 185, 35, 35, (255, 20, 149), (95, 95, 95), 7, urlin)
        button("g", 660, 185, 35, 35, (29, 161, 242), (0, 0, 255), 7, urlgh)
